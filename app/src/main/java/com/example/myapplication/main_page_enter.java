...
public class main_page_enter extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
                ...
                try {
                    ...
                    if (success) {
                        ...
                        for (final Announcement a : announcements) {
                            TextView tv = new TextView(main_page_enter.this);

                            tv.setTextSize(20);
                            tv.setText(a.getTitle());
                            tv.setPadding(100, 20, 20, 50);

                            Typeface face = ResourcesCompat.getFont(main_page_enter.this, R.font.bmdohyeon);
                            tv.setTypeface(face);
                            ...
                            tv.setOnClickListener(new TextView.OnClickListener() {
                                ...
                                public void onClick(View v) {
                                    Intent intent = new Intent(main_page_enter.this, OrderDataActivity.class);
                        ...
                        AlertDialog.Builder builder = new AlertDialog.Builder(main_page_enter.this);
        ...
        RequestQueue queue = Volley.newRequestQueue(main_page_enter.this);
        ...
        */
        ...
        test_button.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(main_page_enter.this, test_enter.class);
        ...
        rank_btn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(main_page_enter.this, ranking_page_enter.class);
                startActivity(intent);
            }
        });
        home_btn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(main_page_enter.this, main_page_enter.class);
                startActivity(intent);
            }
        });
    }
